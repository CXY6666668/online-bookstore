package com.cxa.buss.controller;
...
import com.cxa.buss.service.StudentService;
import com.cxa.common.controller.BaseController;
import com.cxa.common.util.AjaxJson;
...
public class StudentController extends BaseController {
	...
	@ResponseBody
	public AjaxJson save(HttpServletRequest request, HttpServletResponse response, StudentEntity student, String dormid,
	...
	@ResponseBody
	public AjaxJson update(HttpServletRequest request, HttpServletResponse response, StudentEntity student,
			String dormid, String classid) throws Exception {
		AjaxJson j = new AjaxJson();
		j.setMsg("更新成功！");
		j.setSuccess(true);
		try {
	...
	@ResponseBody
	public void datagrid(HttpServletRequest request, HttpServletResponse response, StudentEntity student,
		...
		Pagination<?> pagination = studentService.findPageData(condition, student, Integer.parseInt(page),
