...
<body>
	<table id="dg" class="" title="列表" style="width: 700px; height: 300px">
		<thead>
			<tr>
				...
				<th data-options="field:'name',width:80">图书名</th>
				<th data-options="field:'sex',width:80" formatter="changeValue">单价</th>
				<th data-options="field:'birthday',width:80" formatter="changeDate">出生日期</th>
				<th data-options="field:'qq',width:80">作者</th>
				<th data-options="field:'mobile',width:80">图片</th>
				<th data-options="field:'classname',width:80" formatter="changeClassname">描述</th>
				<th data-options="field:'dormname',width:80" formatter="changeDormname">分类编码</th>
			</tr>
		</thead>
	</table>
	...
	<div id="toolbar">
		...
		<div>
			图书名: <input class="easyui-textbox" id="paramStudent">
			作者: <input class="easyui-textbox" id="paramMobile">
			分类: <input class="easyui-textbox" id="paramQq">
	...
	function loadDataGrid(queryConditon){
		 $('#dg').datagrid({  
	            ...
	            url:'bookController.do?datagrid',//url调用Action方法  
	            loadMsg : '数据装载中......',  
