...
<table cellpadding="0" cellspacing="0" class="gwc_tb1">
  ...
  <script type="text/javascript">
	...
	<table height="165" cellpadding="0" cellspacing="0" class="gwc_tb2">
		<tr>
			<td class="tb2_td1"><input type="checkbox" value="1" name="newslist" id="newslist-1" /></td>
			<td class="tb2_td2"><a href="#"><img src="images/img1.jpg" height="150"/></a></td>
...
<table cellpadding="0" cellspacing="0" class="gwc_tb2">
		<tr>
			<td height="155" class="tb2_td1"><input type="checkbox" value="1" name="newslist" id="newslist-2" /></td>
		  <td class="tb2_td2"><a href="#"><img src="images/img2.jpg" height="150"/></a></td>
			<td class="tb2_td3"><a href="#">产品标题</a></td>
			<td class="tb1_td4">一件</td>
			<td class="tb1_td5">
